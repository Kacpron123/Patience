...
protected:
    ...
    /// @brief updating placing of the cards
    virtual void update();
    ...
    /// @brief update after sending card
    virtual void updatesender() = 0;
    /// @brief update after receiving card
...
public:
    ...
    /// @return -2 if not, -1 if clicked at empty depot in override, and 0+ which Card
    ...
    /// @brief move cards from sender to receiver starting from num card
    static void piletopile(Depot* sender, int num, Depot* receiver,bool brute=false); 
